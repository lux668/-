...
public class GradeController extends BaseController<Grade> {
  ...
  public GradeController(
      GradeService gradeService, StudentService studentService, CourseService courseService) {
