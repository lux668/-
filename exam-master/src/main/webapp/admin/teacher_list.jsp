            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable">
                ...
                <c:forEach items="${teachers}" var="item">
                    <tr align="center">
                        ...
                        <td>${item.phone}</td>
                        <td>${item.address}</td>
                        <td>${item.type == 1 ? '第二课堂':'第一课堂'}</td>
                        <td><a href="${pageContext.request.contextPath}/teacher/getById?id=${item.id}">编辑</a>&nbsp;&nbsp;<a
                                href="${pageContext.request.contextPath}/teacher/delete?id=${item.id}"
