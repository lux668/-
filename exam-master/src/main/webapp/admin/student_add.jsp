...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/student/add" name="myform" method="post"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow" hidden="hidden">
                    <label>学生ID</label>
                    <div class="formRight">
                        <input type="text" name="id" class="mws-textinput" id="id"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>学生账号</label>
                    <div class="formRight">
                        <input type="text" name="account" class="mws-textinput" id="account"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>学生密码</label>
                    <div class="formRight">
                        <input type="text" name="password" class="mws-textinput" id="password"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>学生姓名</label>
                    <div class="formRight">
                        <input type="text" name="name" class="mws-textinput" id="name"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                ...
                <div class="formRow">
                    <label>学生电话</label>
                    <div class="formRight">
                        <input type="text" name="phone" class="mws-textinput" id="phone"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>学生地址</label>
                    <div class="formRight">
                        <input type="text" name="address" class="mws-textinput" id="address"/>
                    </div>
                    <div class="clear"></div>
                </div>
