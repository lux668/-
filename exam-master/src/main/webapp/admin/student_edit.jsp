...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/student/edit" name="myform" method="post"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <select name="gender">
                            <option value="男"
                                    <c:if test='${"男" eq student.gender}'>selected</c:if> >男
                            </option>
                            <option value="女"
                                    <c:if test='${"女" eq student.gender}'>selected</c:if> >女
                            </option>
                        </select>
                    </div>
                    <div class="clear"></div>
