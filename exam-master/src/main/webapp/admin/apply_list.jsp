                    ...
                    <tr align="center">
                        ...
                        <td>
                            <c:if test="${item.status == 0}">
                                <a href="${pageContext.request.contextPath}/apply/handle?res=ok&id=${item.id}">通过</a>
                                <a href="${pageContext.request.contextPath}/apply/handle?res=rej&id=${item.id}">不通过</a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
