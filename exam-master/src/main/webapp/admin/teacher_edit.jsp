...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/teacher/edit" name="myform" method="post"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow" hidden="hidden">
                    <label>老师ID</label>
                    <div class="formRight">
                        <input type="text" name="id" class="mws-textinput" value="${teacher.id}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>老师账号</label>
                    <div class="formRight">
                        <input type="text" name="account" class="mws-textinput" value="${teacher.account}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>老师密码</label>
                    <div class="formRight">
                        <input type="text" name="password" class="mws-textinput" value="${teacher.password}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>老师姓名</label>
                    <div class="formRight">
                        <input type="text" name="name" class="mws-textinput" value="${teacher.name}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <select name="gender">
                            <option value="男"
                                    <c:if test='${"男" eq teacher.gender}'>selected</c:if> >男
                            </option>
                            <option value="女"
                                    <c:if test='${"女" eq teacher.gender}'>selected</c:if> >女
                            </option>
                        </select>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="formRow">
                    <label>老师电话</label>
                    <div class="formRight">
                        <input type="text" name="phone" class="mws-textinput" value="${teacher.phone}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>老师地址</label>
                    <div class="formRight">
                        <input type="text" name="address" class="mws-textinput" value="${teacher.address}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <select name="type">
                            <option value="0"
                                    <c:if test="${'0' eq teacher.type}">selected</c:if> >否
                            </option>
                            <option value="1"
                                    <c:if test="${'1' eq teacher.type}">selected</c:if> >是
                            </option>
                        </select>
                    </div>
                    <div class="clear"></div>
