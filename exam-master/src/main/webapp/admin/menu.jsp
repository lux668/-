...
<div id="leftSide">
    ...
    <ul id="menu" class="nav">
        ...
        <c:if test="${sessionScope.session_admin != null}">
            ...
            <%--            <li class="tables"><a title="账户管理" class="exp"><span>账户管理</span><strong>2</strong></a>--%>
            <%--                <ul class="sub">--%>
            <%--                    <li><a href="${pageContext.request.contextPath}/account/toAdd" title="修改个人信息">修改个人信息</a></li>--%>
            <%--                    <li><a href="${pageContext.request.contextPath}/account/toList" title="修改密码">修改密码</a></li>--%>
            <%--                </ul>--%>
            <%--            </li>--%>
        </c:if>
        <c:if test="${sessionScope.session_teacher != null}">
            ...
            <li class="tables"><a title="账户管理" class="exp"><span>账户管理</span><strong></strong></a>
                <ul class="sub">
                        <%--                    <li><a href="${pageContext.request.contextPath}/account/toAdd" title="修改个人信息">修改个人信息</a></li>--%>
                    <li>
                        <a href="${pageContext.request.contextPath}/teacher/getById?id=${sessionScope.session_teacher.id}">修改个人信息</a>
                    </li>
                        <%--                    <li><a href="${pageContext.request.contextPath}/account/toList" title="修改密码">修改密码</a></li>--%>
                </ul>
            </li>
        ...
        <c:if test="${sessionScope.session_student != null}">
            ...
            <li class="tables"><a title="账户管理" class="exp"><span>账户管理</span><strong></strong></a>
                <ul class="sub">
                    <li>
                        <a href="${pageContext.request.contextPath}/student/getById?id=${sessionScope.session_student.id}">修改个人信息</a>
                    </li>
                        <%--                    <li><a href="${pageContext.request.contextPath}/account/toList" title="修改密码">修改密码</a></li>--%>
                </ul>
            </li>
