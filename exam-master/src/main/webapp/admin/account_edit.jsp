...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/account/edit" name="myform" method="post"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow" hidden="hidden">
                    <label>个人ID</label>
                    <div class="formRight">
                        <input type="text" name="id" class="mws-textinput" value="${account.id}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>账号</label>
                    <div class="formRight">
                        <input type="text" name="account" class="mws-textinput" value="${account.accountid}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>密码</label>
                    <div class="formRight">
                        <input type="text" name="password" class="mws-textinput" value="${account.password}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>姓名</label>
                    <div class="formRight">
                        <input type="text" name="name" class="mws-textinput" value="${account.name}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <select name="gender">
                            <option value="男"
                                    <c:if test='${"男" eq account.gender}'>selected</c:if> >男
                            </option>
                            <option value="女"
                                    <c:if test='${"女" eq account.gender}'>selected</c:if> >女
                            </option>
                        </select>
                    </div>
                    <div class="clear"></div>
                ...
                <div class="formRow">
                    <label>电话</label>
                    <div class="formRight">
                        <input type="text" name="phone" class="mws-textinput" value="${account.phone}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>地址</label>
                    <div class="formRight">
                        <input type="text" name="address" class="mws-textinput" value="${account.address}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>身份证号</label>
                    <div class="formRight">
                        <input type="text" name="identity" class="mws-textinput" value="${account.identity}"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>专业</label>
                    <div class="formRight">
                        <input type="text" name="profession" class="mws-textinput" value="${account.profession}"/>
                    </div>
                    <div class="clear"></div>
                </div>
