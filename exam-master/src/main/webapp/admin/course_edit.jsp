...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/course/edit" name="myform" method="post"
              onsubmit="return true;" class="form">
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow" hidden="hidden">
                    <label>课程ID</label>
                    <div class="formRight">
                        <input type="text" name="id" class="mws-textinput" id="id" value="${course.id}"
                               placeholder="请输入课程id"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>课程名称</label>
                    <div class="formRight">
                        <input type="text" name="name" class="mws-textinput" id="name" value="${course.name}"
                               placeholder="请输入课程名称"/>
                    </div>
                    <div class="clear"></div>
                </div>
