...
<div id="rightSide">
    ...
    <div class="line"></div>
    <div class="wrapper">
        <form action="${pageContext.request.contextPath}/account/add" name="myform" method="post"
            ...
            <div class="widget" style="width: 40%">
                ...
                <div class="formRow" hidden="hidden">
                    <label>个人ID</label>
                    <div class="formRight">
                        <input type="text" name="id" class="mws-textinput"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
                    <label>账号</label>
                    <div class="formRight">
                        <input type="text" name="accountid" class="mws-textinput" id="accountid"/>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="formRow">
